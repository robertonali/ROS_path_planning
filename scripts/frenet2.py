...
TARGET_SPEED = 2.5  # target speed [m/s]
...
class Odom(object):
    def __init__(self):
        self.waypoints   = np.genfromtxt('./ros_wall_follower/scripts/csv/frenet3.csv', delimiter=',')
    ...
    def laserCallback(self, msg):
        if(self.obstacles_ready == False):
            ...
            for i in self.laser_angle_range:
                ...
                # mike_distancia.append(distance)
            ...
            # np.savetxt('./ros_wall_follower/scripts/csv/distancia.csv', mike_distancia, delimiter = ",")
            # np.savetxt('./ros_wall_follower/scripts/csv/distcalculado.csv', self.laser_obs, delimiter = ",")
